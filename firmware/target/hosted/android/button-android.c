...
Java_com_gaana_RockboxFramebuffer_touchHandler(JNIEnv*env, jobject this,
...
Java_com_gaana_RockboxFramebuffer_buttonHandler(JNIEnv*env, jclass class,
...
{
    JNIEnv e = *env_ptr;
    jclass class = e->FindClass(env_ptr, "com/gaana/monitors/HeadphoneMonitor");
...
static int hp_state;
JNIEXPORT void JNICALL
Java_com_gaana_monitors_HeadphoneMonitor_postHpStateChanged(JNIEnv *env,
                                                            jobject this,
                                                            jint state)
{
    (void)env; (void)this;

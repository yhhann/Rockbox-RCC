...
Java_com_gaana_Helper_RunForegroundManager_getTitle(JNIEnv *env, jobject this)
{
    (void)env;
    (void)this;
    return title;
...
JNIEXPORT jstring JNICALL
Java_com_gaana_Helper_RunForegroundManager_getArtist(JNIEnv *env, jobject this)
{
    (void)env;
    (void)this;
    return artist;
...
JNIEXPORT jstring JNICALL
Java_com_gaana_Helper_RunForegroundManager_getAlbum(JNIEnv *env, jobject this)
{
    (void)env;
    (void)this;
    return album;
...
JNIEXPORT jstring JNICALL
Java_com_gaana_Helper_RunForegroundManager_getAlbumart(JNIEnv *env, jobject this)
{
    (void)env;
    (void)this;
    return albumart;
...
void notification_init_(void)
{
    ...
    jfieldID nNM = e->GetFieldID(env_ptr, RockboxService_class,
                    "mFgRunner", "Lcom/gaana/Helper/RunForegroundManager;");
